...
namespace Gestion.Colegial.UI.Forms.Semestres
{
    public partial class List : FormBase
    {
        ...
        public void DataGridViewFill(string buscar = "")
        {
            ...
            // Peticion de la data
            DataTable data = SemestresServices.List(buscar);
            //if (data==null)
            //{
        ...
        {
            ///var obj = SemestresServices.List("");
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[2].Selected)
            {
                ...
                if (Warning.isOk())
                {
                    ...
                    Boolean resultService = SemestresServices.Remove(objSemestres.Sem_Id);
                    DataGridViewFill();
                    if (resultService)
                    {
        ...
        //    }
        //    System.Collections.Generic.List<tbSemestres> lista = new System.Collections.Generic.List<tbSemestres>();
        //    lista.Add(new tbSemestres()
        //    {
        //        //mda_Descripcion = 
        //    });
