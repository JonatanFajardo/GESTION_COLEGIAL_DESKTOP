...
namespace Gestion.Colegial.UI.Forms.Horas
{
    public partial class List : FormBase
    {
        ...
        public void DataGridViewFill(string buscar = "")
        {
            ...
            // Peticion de la data
            DataTable data = HorasServices.List(buscar);
            //if (data==null)
            //{
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[2].Selected)
            {
                ...
                if (Warning.isOk())
                {
                    ...
                    Boolean resultService = HorasServices.Remove(objHoras.Hor_Id);
                    DataGridViewFill();
                    if (resultService)
                    {
        ...
        //    }
        //    System.Collections.Generic.List<tbHoras> lista = new System.Collections.Generic.List<tbHoras>();
        //    lista.Add(new tbHoras()
        //    {
        //        //mda_Descripcion = 
        //    });
