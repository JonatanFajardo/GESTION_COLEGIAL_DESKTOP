...
namespace Gestion.Colegial.UI.Forms.NivelesEducativos
{
    public partial class Add : Add_Base
    {
        ...
        private NivelesEducativos.List _list;
        ...
        {
            Answer ServiceInsert = await NivelesEducativosServices.ListOne(id);
            if (!ServiceInsert.Access)
            {
                PR_tbNivelesEducativos_FindResult Entity = ServiceInsert.Data;
                txtDescripcion.Texts = Entity.Niv_Descripcion;
            }
            else
