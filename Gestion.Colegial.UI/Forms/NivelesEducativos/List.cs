...
namespace Gestion.Colegial.UI.Forms.NivelesEducativos
{
    public partial class List : FormBase
    {
        ...
        public void DataGridViewFill(string buscar = "")
        {
            ...
            // Peticion de la data
            DataTable data = NivelesEducativosServices.List(buscar);
            //if (data==null)
            //{
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[2].Selected)
            {
                ...
                if (Warning.isOk())
                {
                    ...
                    Boolean resultService = NivelesEducativosServices.Remove(objNivelesEducativos.Niv_Id);
                    DataGridViewFill();
                    if (resultService)
                    {
        ...
        //    }
        //    System.Collections.Generic.List<tbNivelesEducativos> lista = new System.Collections.Generic.List<tbNivelesEducativos>();
        //    lista.Add(new tbNivelesEducativos()
        //    {
        //        //mda_Descripcion = 
        //    });
