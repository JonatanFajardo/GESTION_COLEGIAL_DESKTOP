    ...
    public partial class List : FormBase
    {
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[0].Selected)
            {
                ...
                tbMaterias objMaterias = new tbMaterias()
                {
                    Mat_Id = Convert.ToInt32(dataGridViewJN1.Rows[e.RowIndex].Cells[e.ColumnIndex + 3].Value),
                    Mat_Nombre = dataGridViewJN1.Rows[e.RowIndex].Cells[e.ColumnIndex + 4].Value.ToString()
                };
                Add.Send(objMaterias);
            }
        ...
        //    }
        //    System.Collections.Generic.List<tbMaterias> lista = new System.Collections.Generic.List<tbMaterias>();
        //    lista.Add(new tbMaterias()
        //    {
        //        //mda_Descripcion = 
        //    });
