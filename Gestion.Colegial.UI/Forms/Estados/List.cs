...
namespace Gestion.Colegial.UI.Forms.Estados
{
    public partial class List : FormBase
    {
        ...
        public void DataGridViewFill(string buscar = "")
        {
            ...
            // Peticion de la data
            DataTable data = EstadosServices.List(buscar);
            //if (data==null)
            //{
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[2].Selected)
            {
                ...
                if (Warning.isOk())
                {
                    ...
                    Boolean resultService = EstadosServices.Remove(objEstados.Est_Id);
                    DataGridViewFill();
                    if (resultService)
                    {
        ...
        //    }
        //    System.Collections.Generic.List<tbEstados> lista = new System.Collections.Generic.List<tbEstados>();
        //    lista.Add(new tbEstados()
        //    {
        //        //mda_Descripcion = 
        //    });
