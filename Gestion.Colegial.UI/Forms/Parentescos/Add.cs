...
namespace Gestion.Colegial.UI.Forms.Parentescos
{
    public partial class Add : Add_Base
    {
        ...
        private Parentescos.List _list;
        ...
        {
            Answer ServiceInsert = await ParentescosServices.ListOne(id);
            if (!ServiceInsert.Access)
            {
                PR_tbParentescos_FindResult Entity = ServiceInsert.Data;
                txtDescripcion.Texts = Entity.Par_Descripcion;
            }
            else
