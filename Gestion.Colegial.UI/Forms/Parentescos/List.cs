...
namespace Gestion.Colegial.UI.Forms.Parentescos
{
    public partial class List : FormBase
    {
        ...
        public void DataGridViewFill(string buscar = "")
        {
            ...
            // Peticion de la data
            DataTable data = ParentescosServices.List(buscar);
            //if (data==null)
            //{
        ...
        public override void CellContentDGV(DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewJN1.Rows[e.RowIndex].Cells[2].Selected)
            {
                ...
                if (Warning.isOk())
                {
                    ...
                    Boolean resultService = ParentescosServices.Remove(objParentescos.Par_Id);
                    DataGridViewFill();
                    if (resultService)
                    {
        ...
        //    }
        //    System.Collections.Generic.List<tbParentescos> lista = new System.Collections.Generic.List<tbParentescos>();
        //    lista.Add(new tbParentescos()
        //    {
        //        //mda_Descripcion = 
        //    });
