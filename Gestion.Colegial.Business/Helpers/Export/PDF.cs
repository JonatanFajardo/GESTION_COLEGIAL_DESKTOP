...
namespace Gestion.Colegial.Business.Helpers.Export //AllocationRequest
{
    ...
    public static class Extensions
    {
            ...
            Graphics g, int pagewidth, int pageheight, Margins margins)
        {
            foreach (T t in list)
            {
                if (t is PDF.ImbeddedImage)
                {
                    PDF.ImbeddedImage ii = (PDF.ImbeddedImage)Convert.ChangeType(t, typeof(PDF.ImbeddedImage));
    ...
    public class PDF
    {
        ...
        public void PrintDataGridView(DataGridView dgv)
        {
            ...
            if (null == dgv) throw new Exception("Null Parameter passed to PDF.");
            if (!(typeof(DataGridView).IsInstanceOfType(dgv)))
                throw new Exception("Invalid Parameter passed to PDF.");
        ...
        public Boolean EmbeddedPrint(DataGridView dgv, Graphics g, Rectangle area)
        {
            ...
            if ((null == dgv))
                throw new Exception("Null Parameter passed to PDF.");
