...
namespace Gestion.Colegial.Business.Services
{
    public class MateriasServices
    {
        ...
        public static async Task<Answer> List()
        {
            ...
            {
                //Peticion.
                List<PR_tbMaterias_ListResult> ApiResult = await ApiRequests.List<PR_tbMaterias_ListResult>(ApiUrl.Materias.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbMaterias_FindResult ApiResult = await ApiRequests.Find<PR_tbMaterias_FindResult>(ApiUrl.Materias.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbMaterias entity)
        {
            try
            {
                return await ApiRequests.Create(ApiUrl.Materias.Create, entity);
            }
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbMaterias entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.Materias.Update, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
