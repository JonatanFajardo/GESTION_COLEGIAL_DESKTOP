...
namespace Gestion.Colegial.Business.Services
{
    public class PersonasServices
    {
        ...
        //    {
        //        //Peticion.
        //        List<PR_tbPersonas_ListResult> ApiResult = await ApiRequests.List<PR_tbPersonas_ListResult>(ApiUrl.Personas.List);
        ...
        //    try
        //    {
        //        PR_tbPersonas_FindResult ApiResult = await ApiRequests.Find<PR_tbPersonas_FindResult>(ApiUrl.Personas.Find, identifier);
        //        if (ApiResult is null)
        //            goto ErrorResult;
