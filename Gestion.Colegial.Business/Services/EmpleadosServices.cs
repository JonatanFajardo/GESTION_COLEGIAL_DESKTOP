...
namespace Gestion.Colegial.Business.Services
{
    public class EmpleadosServices
    {
        ...
        public static async Task<Answer> List(string sear = "")
        {
            ...
            {
                //Peticion.
                List<PR_tbEmpleados_ListResult> ApiResult = await ApiRequests.List<PR_tbEmpleados_ListResult>(ApiUrl.Empleados.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbEmpleados_FindResult ApiResult = await ApiRequests.Find<PR_tbEmpleados_FindResult>(ApiUrl.Empleados.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbEmpleados entity)
        {
            try
            {
            return await ApiRequests.Create(ApiUrl.Empleados.Create, entity);}
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbEmpleados entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.Empleados.Update, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
