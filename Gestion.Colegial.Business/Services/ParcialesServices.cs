...
namespace Gestion.Colegial.Business.Services
{
    public class ParcialesServices
    {
        ...
        public static async Task<Answer> List(string sear = "")
        {
            ...
            {
                //Peticion.
                List<PR_tbParciales_ListResult> ApiResult = await ApiRequests.List<PR_tbParciales_ListResult>(ApiUrl.Parciales.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbParciales_FindResult ApiResult = await ApiRequests.Find<PR_tbParciales_FindResult>(ApiUrl.Parciales.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbParciales entity)
        {
            try
            {
            return await ApiRequests.Create(ApiUrl.Parciales.Create, entity);}
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbParciales entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.Parciales.Update, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
