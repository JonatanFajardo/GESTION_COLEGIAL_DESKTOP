...
namespace Gestion.Colegial.Business.Services
{
    public class CursosNombresServices
    {
        ...
        public static async Task<Answer> List(string sear = "")
        {
            ...
            {
                //Peticion.
                List<PR_tbCursosNombres_ListResult> ApiResult = await ApiRequests.List<PR_tbCursosNombres_ListResult>(ApiUrl.CursosNombres.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbCursosNombres_FindResult ApiResult = await ApiRequests.Find<PR_tbCursosNombres_FindResult>(ApiUrl.CursosNombres.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbCursosNombres entity)
        {
            try
            {
            return await ApiRequests.Create(ApiUrl.CursosNombres.Create, entity);}
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbCursosNombres entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.CursosNombres.Create, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
