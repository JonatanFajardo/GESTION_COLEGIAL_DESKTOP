...
namespace Gestion.Colegial.Business.Services
{
    public class CursosServices
    {
        ...
        public static async Task<Answer> List()
        {
            ...
            {
                //Peticion.
                List<PR_tbCursos_ListResult> ApiResult = await ApiRequests.List<PR_tbCursos_ListResult>(ApiUrl.Cursos.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbCursos_FindResult ApiResult = await ApiRequests.Find<PR_tbCursos_FindResult>(ApiUrl.Cursos.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbCursos entity)
        {
            try
            {
                return await ApiRequests.Create(ApiUrl.Cursos.Create, entity);
            }
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbCursos entity)
        {
            try
            {
                return await ApiRequests.Edit(ApiUrl.Cursos.Update, entity);
            }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
