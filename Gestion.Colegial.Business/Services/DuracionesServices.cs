...
namespace Gestion.Colegial.Business.Services
{
    public class DuracionesServices
    {
        ...
        public static async Task<Answer> List(string sear = "")
        {
            ...
            {
                //Peticion.
                List<PR_tbDuraciones_ListResult> ApiResult = await ApiRequests.List<PR_tbDuraciones_ListResult>(ApiUrl.Duraciones.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbDuraciones_FindResult ApiResult = await ApiRequests.Find<PR_tbDuraciones_FindResult>(ApiUrl.Duraciones.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbDuraciones entity)
        {
            try
            {
            return await ApiRequests.Create(ApiUrl.Duraciones.Create, entity);}
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbDuraciones entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.Duraciones.Update, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
