...
namespace Gestion.Colegial.Business.Services
{
    public class EstadosServices
    {
        ...
        public static async Task<Answer> List(string sear = "")
        {
            ...
            {
                //Peticion.
                List<PR_tbEstados_ListResult> ApiResult = await ApiRequests.List<PR_tbEstados_ListResult>(ApiUrl.Estados.List);
        ...
        public static async Task<Answer> ListOne(int identifier)
        {
            try
            {
                PR_tbEstados_FindResult ApiResult = await ApiRequests.Find<PR_tbEstados_FindResult>(ApiUrl.Estados.Find, identifier);
                if (ApiResult is null)
                    goto ErrorResult;
        ...
        public static async Task<Boolean> Add(tbEstados entity)
        {
            try
            {
                return await ApiRequests.Create(ApiUrl.Estados.Create, entity);}
            catch (Exception error)
            {
        ...
        public static async Task<Boolean> Edit(tbEstados entity)
        {
            try
            {
            return await ApiRequests.Edit(ApiUrl.Estados.Update, entity);
        }
            catch (Exception error)
            {
               return ErrorLog.Incidents(error);
